...
public class EverythingRecyclerViewAdapter extends RecyclerView.Adapter<EverythingRecyclerViewAdapter.ViewHolder> {

    private Context context;
    private List<Article> articles;
    private LaterArticleViewModel laterArticleViewModel;

    public EverythingRecyclerViewAdapter(Context context, List<Article> articles, LaterArticleViewModel laterArticleViewModel) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new EverythingRecyclerViewAdapter.ViewHolder(view);
    }
